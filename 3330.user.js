...
function mfn_preload() {
	...
	mfn_posterNode.setAttribute("style","background:#D0D000;color:#222;margin:0 .5ex;");
	mfn_posterNode.setAttribute("class","staff");
	...
	mfn_userNode.setAttribute("style","background:#CC9;color:#333;margin:0 .5ex;");
	mfn_userNode.setAttribute("class","staff");
